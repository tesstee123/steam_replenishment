...
def main():
    ...
    if st.button("Пополнить счет"):
        ...
        webbrowser.open_new_tab("https://yoomoney.ru/quickpay/confirm.xml?receiver=4100116565978076&quickpay-form=shop&targets=Sponsor%20this%20project&paymentType=SB&sum=2&label=a1b2c3d4e6")
